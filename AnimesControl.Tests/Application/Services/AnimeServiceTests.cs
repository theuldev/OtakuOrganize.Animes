...
namespace AnimesControl.Tests.Application.Services
{
    public class AnimeServiceTests
    {
        ...
        public void ValidAnime_PostIsCalled_AnimeModelMustAddInDatabase()
        {
            ...
            var settings = new DbContextOptionsBuilder<AnimeContext>().UseInMemoryDatabase(databaseName: "AnimeDatabase").Options;

            using (var context = new AnimeContext(settings))
            {
